...
class RegProduct extends Component {
  ...
  render() {
    const { posting, posted }= this.props;
        ...
        <div class="ui grid">
          ...
          <div class="eight wide column">
            ...
            <div className="orderPreview">
              ...
              <div>
                <div>
                  <input placeholder={this.state.productCode} />
                </div>
              </div>
              <div>
                <h3>Total Order</h3>
              ...
              <div>
                <div>
                  <input placeholder={this.state.totalOrder} />
                </div>
              </div>
              <div>
                <h3>Product Price</h3>
              ...
              <div>
                <div>
                  <input placeholder={this.state.productPrice} />
                </div>
              </div>
              <div>
                <h3>Total Price</h3>
              ...
              <div>
                <div>
                  <input placeholder={this.state.totalPrice} />
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="ui grid">
          ...
          <div class="eight wide column">
            ...
            <div>
              ...
              />
              <Link to="/transaction/onTransaction">
                <button>Go onTransaction</button>
              </Link>
            </div>
          </div>
        </div>
...
function mapStateToProps(state) {
  const { posting, posted } = state.post;
  return { 
    posting,
    posted
  };
...
export default connect(mapStateToProps)(RegProduct);
